...
async function execute(message, serverQueue) {
  ...
  if (!serverQueue) {
    ...
    return  client.channels.cache.get('730869961475489903').send(`${song.title} أضيف لقائمة الإنتظار`);
  }
}
...
function play(guild, song) {
  ...
  serverQueue.client.channels.cache.get('730869961475489903').send(`شغال`);
}
